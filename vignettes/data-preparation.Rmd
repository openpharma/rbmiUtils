...
When subjects discontinue treatment, you may want to apply reference-based imputation strategies. The `prepare_data_ice()` function builds the required `data_ice` data.frame from a discontinuation flag:
