---
title: "Single_analysis_workflow"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Single_analysis_workflow}
...
method <- rbmi::method_bayes(
    n_samples = mi_parameters$IMPUTATIONS,
    control = rbmi::control_bayes(
      warmup = mi_parameters$WARMUP,
      thin = mi_parameters$THIN
      )
    )
